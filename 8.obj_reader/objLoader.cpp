...
//
//
//	 //각 Vertex의 x,y,z값을 받아 m_vertex 배열에 저장
//
//	 //read vertex local coordinate
//	 //read &m_vertex[i][0], &m_vertex[i][1], &m_vertex[i][2] (v)
//
//	 //if) vertex 배열을 읽다 파일 형식이 달라진 경우, 배열에 집어넣는 것을 멈추고  현재의 인덱스를 저장하여 총 Vertex의 갯수를 저장 후 다음 작업으로 넘어간다.
//
//	 //read texture coordinate
//	 //read &m_texture[i][0], &m_texture[i][1], &m_texture[i][2]  (vt)
//
//	
//
//	 //read vertex normal
//	 //read &m_vertexNormal[i][0], &m_vertexNormal[i][1], &m_vertexNormal[i][2]  (vn)
//
//	
//
//	 //confrimed group
...
//	 //read s
//
//	 //confirm each face's coordinate, texture, normal index
//	 //read f v / vt / vn, v / vt / vn, v / vt / vn 
//
//	 //read f, s, f, f
//	 //read #count faces
//
