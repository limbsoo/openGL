...
public:
	...
	float m_zBuffer[checkImageHeight][checkImageWidth] = { 1, };

	float  m_copyZBuffer[checkImageHeight][checkImageWidth][3];
	...
	float floorWorldLightingDepthBuffer[checkImageHeight][checkImageWidth] = { 1, };
