...
void keyboard(unsigned char key, int x, int y)
{
	...
	//case '4':
	//	g_renderer.m_world = translateMatrix(-200.0f, 0, 0) * g_renderer.m_world;
	//	glutPostRedisplay();
	...
	//case '8':
	//	g_renderer.m_world = translateMatrix(0, -200.0f, 0) * g_renderer.m_world;
	//	glutPostRedisplay();
	...
	case 'w':
		...
		eye = xRotateMatrix(seta) * zRotateMatrix(0.5f) * cameraScaleMatrix(length) * a;
	...
	case 'a':
		...
		eye = yRotateMatrix(seta) * xRotateMatrix(0.5f) * cameraScaleMatrix(length) * a;
